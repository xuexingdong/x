...
CREATE INDEX IF NOT EXISTS idx_created_at ON x_pay_app (created_at);
CREATE INDEX IF NOT EXISTS idx_updated_at ON x_pay_app (updated_at);
...
CREATE INDEX IF NOT EXISTS idx_created_at ON x_pay_merchant (created_at);
CREATE INDEX IF NOT EXISTS idx_updated_at ON x_pay_merchant (updated_at);
