...
import cool.xxd.service.pay.application.converter.MerchantPayChannelConverter;
import cool.xxd.service.pay.application.mapper.MerchantPayChannelMapper;
...
public class MerchantPayChannelRepositoryImpl implements MerchantPayChannelRepository {
    ...
    public List<MerchantPayChannel> findByIds(List<Long> ids) {
        ...
        var merchantPayChannelDOList = merchantPayChannelMapper.selectByIds(ids);
